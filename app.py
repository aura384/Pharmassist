...
def multi_drug_info():
    ...
    try:
        ...
        for drug_name in drug_names:
            ...
            try:
                ...
                if local_info and 'side_effects' in local_info:
                    ...
                    # Add additional properties from local dataset if available
                    for key in ['molecular_formula', 'molecular_weight', 'iupac_name']:
                        if key in local_info:
                            drug_data[key] = local_info[key]
                else:
                    # If local dataset also fails, proceed with side effects only
                    side_effects = get_side_effects(drug_name)
                    drug_data = {
                        'drug_name': drug_name,
            ...
            # Store all side effects for GNN analysis
        ...
        # Use GNN to analyze side effects relationships
